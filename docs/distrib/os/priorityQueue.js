...
(function (TSOS) {
    class PriorityQueue {
         ...
         */
        enqueueInterruptOrPcb(newInterruptOrPcb) {
            ...
            var foundQueueWithMatchingPriority = false;
            var pos = 0;
            ...
            if (!foundQueueWithMatchingPriority) {
                ...
                this.queues.push(new TSOS.Queue([newInterruptOrPcb], newInterruptOrPcb.priority));
        ...
        changePriority(pcb, newPriority) {
            /**
             * Here's the strategy...
