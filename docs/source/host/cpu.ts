...
module TSOS {
    ...
    export class Cpu {
        ...
        public break() {
            ...
            _KernelInterruptPriorityQueue.enqueueInterruptOrPcb(new TSOS.Interrupt(TERMINATE_PROCESS_IRQ, []));
        ...
        public sysCall () {
            ...
            if (parseInt(this.Xreg, 16) === 1) {
                _KernelInterruptPriorityQueue.enqueueInterruptOrPcb(new TSOS.Interrupt(SYS_CALL_IRQ, [this.localPCB]));
            }/// if
