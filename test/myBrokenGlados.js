...
function Glados() {
    ...
    this.init = function() {
       var msg = "Hello [subject name here]. Here's 3 programs to start.\n";
       alert(msg);
    };
